...
define( 'controllers/AppController',['require','underscore','jquery','backbone','marionette','async','views/ErrorView'],function ( require ) {
	'use strict';
...
define( 'config/index',['require','porthole','modernizr'],function ( require ) {
	'use strict';
