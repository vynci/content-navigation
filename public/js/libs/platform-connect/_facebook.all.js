...
try {
    ...
    var self = window,
        ...
        var ES5 = function () {
            ...
            define("ES5ArrayPrototype", [], function (a, require, requireDynamic, requireLazy, module, f) {
                var g = {};
                g.map = function (h, i) {
            ...
            define("ES5FunctionPrototype", [], function (a, require, requireDynamic, requireLazy, module, f) {
                var g = {};
                g.bind = function (h) {
            ...
            define("ES5StringPrototype", [], function (a, require, requireDynamic, requireLazy, module, f) {
                var g = {};
                g.trim = function () {
            ...
            define("ES5Array", [], function (a, require, requireDynamic, requireLazy, module, f) {
                var g = {};
            ...
            define("ES5Object", [], function (a, require, requireDynamic, requireLazy, module, f) {
                var g = {};
                g.create = function (h) {
                    var i = typeof h;
            ...
            define("ES5Date", [], function (a, require, requireDynamic, requireLazy, module, f) {
                var g = {};
                g.now = function () {
            ...
            define("JSON3", [], function (a, require, requireDynamic, requireLazy, module, f) {
                (function () {
                    var g = {}.toString,
            ...
            define("ES5", ["ES5ArrayPrototype", "ES5FunctionPrototype", "ES5StringPrototype", "ES5Array", "ES5Object", "ES5Date", "JSON3"], function (a, require, requireDynamic, requireLazy, module, f) {
        ...
        define("QueryString", [], function (a, require, requireDynamic, requireLazy, module, f) {
            function g(k) {
                var l = [];
        ...
        define("copyProperties", [], function (a, require, requireDynamic, requireLazy, module, f) {
        ...
        define("ManagedError", [], function (a, require, requireDynamic, requireLazy, module, f) {
            function g(h, i) {
        ...
        define("AssertionError", ["ManagedError"], function (a, require, requireDynamic, requireLazy, module, f) {
        ...
        define("sprintf", [], function (a, require, requireDynamic, requireLazy, module, f) {
            function g(h) {
        ...
        define("Assert", ["AssertionError", "sprintf"], function (a, require, requireDynamic, requireLazy, module, f) {
        ...
        define("Type", ["copyProperties", "Assert"], function (a, require, requireDynamic, requireLazy, module, f) {
        ...
        define("ObservableMixin", [], function (a, require, requireDynamic, requireLazy, module, f) {
            function g() {
        ...
        define("sdk.Model", ["Type", "ObservableMixin"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('Type'),
        ...
        define("sdk.Runtime", ["sdk.Model", "copyProperties", "sdk.RuntimeConfig"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('sdk.Model'),
                h = requireDynamic('sdk.RuntimeConfig'),
        ...
        define("sdk.Cookie", ["QueryString", "sdk.Runtime"], function (a, require, requireDynamic, requireLazy, module, f) {
        ...
        define("guid", [], function (a, require, requireDynamic, requireLazy, module, f) {
            function g() {
        ...
        define("hasNamePropertyBug", ["guid"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('guid'),
                h;
        ...
        define("wrapFunction", [], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = {};
        ...
        define("DOMEventListener", ["wrapFunction"], function (a, require, requireDynamic, requireLazy, module, f) {
        ...
        define("sdk.createIframe", ["copyProperties", "guid", "hasNamePropertyBug", "DOMEventListener"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('copyProperties'),
                h = require('guid'),
        ...
        define("DOMWrapper", [], function (a, require, requireDynamic, requireLazy, module, f) {
            var g, h, i = {
                    setRoot: function (j) {
                        g = j;
                    },
        ...
        define("sdk.feature", ["SDKConfig"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = requireDynamic('SDKConfig');
        ...
        define("UserAgent", [], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = false,
        ...
        define("sdk.getContextType", ["UserAgent", "sdk.Runtime"], function (a, require, requireDynamic, requireLazy, module, f) {
        ...
        define("UrlMap", ["UrlMapConfig"], function (a, require, requireDynamic, requireLazy, module, f) {
        ...
        define("sdk.Impressions", ["guid", "QueryString", "sdk.Runtime", "UrlMap"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('guid'),
        ...
        define("Log", ["sprintf"], function (a, require, requireDynamic, requireLazy, module, f) {
        ...
        define("Base64", [], function (a, require, requireDynamic, requireLazy, module, f) {
        ...
        define("sdk.SignedRequest", ["Base64"], function (a, require, requireDynamic, requireLazy, module, f) {
        ...
        define("URL", ["Assert", "copyProperties", "QueryString", "Log"], function (a, require, requireDynamic, requireLazy, module, f) {
        ...
        define("sdk.domReady", [], function (a, require, requireDynamic, requireLazy, module, f) {
        ...
        define("sdk.Event", [], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = {
        ...
        define("Queue", ["copyProperties"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('copyProperties'),
                h = {};
        ...
        define("resolveURI", [], function (a, require, requireDynamic, requireLazy, module, f) {
            function g(h) {
        ...
        define("resolveWindow", [], function (a, require, requireDynamic, requireLazy, module, f) {
            function g(h) {
                var i = window,
                    j = h.split('.');
                try {
        ...
        define("JSONRPC", ["copyProperties", "Log"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('copyProperties'),
                h = require('Log');
        ...
        define("sdk.RPC", ["Assert", "JSONRPC", "Queue"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('Assert'),
                h = require('JSONRPC'),
                i = require('Queue'),
                j = new i(),
        ...
        define("emptyFunction", ["copyProperties"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('copyProperties');
        ...
        define("Flash", ["DOMWrapper", "QueryString", "UserAgent", "copyProperties", "guid"], function (a, require, requireDynamic, requireLazy, module, f) {
        ...
        define("dotAccess", [], function (a, require, requireDynamic, requireLazy, module, f) {
            function g(h, i, j) {
                var k = i.split('.');
                do {
                    var l = k.shift();
        ...
        define("GlobalCallback", ["DOMWrapper", "dotAccess", "guid", "wrapFunction"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('DOMWrapper'),
                h = require('dotAccess'),
                i = require('guid'),
        ...
        define("XDM", ["DOMEventListener", "DOMWrapper", "emptyFunction", "Flash", "GlobalCallback", "guid", "Log", "UserAgent", "wrapFunction"], function (a, require, requireDynamic, requireLazy, module, f) {
        ...
        define("sdk.XD", ["sdk.Content", "sdk.createIframe", "sdk.Event", "guid", "Log", "QueryString", "Queue", "resolveURI", "resolveWindow", "sdk.RPC", "sdk.Runtime", "UrlMap", "URL", "wrapFunction", "XDM", "XDConfig"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('sdk.Content'),
                ...
                p = require('sdk.RPC'),
                q = require('sdk.Runtime'),
                r = require('UrlMap'),
                s = require('URL'),
                t = require('wrapFunction'),
                u = requireDynamic('XDConfig'),
                v = require('XDM'),
                w = new m(),
                x = new m(),
                y = new m(),
        ...
        define("sdk.Auth", ["sdk.Cookie", "copyProperties", "sdk.createIframe", "DOMWrapper", "sdk.feature", "sdk.getContextType", "guid", "sdk.Impressions", "Log", "ObservableMixin", "QueryString", "sdk.Runtime", "sdk.SignedRequest", "UrlMap", "URL", "sdk.XD"], function (a, require, requireDynamic, requireLazy, module, f) {
            ...
            function ea( callback, ga) {
                ...
                if (callback) {
                    if (!ga && da == 'loaded') {
                        ...
                        return;
                    } else y.subscribe('FB.loginStatus', callback);
                }
        ...
        define("createArrayFrom", [], function (a, require, requireDynamic, requireLazy, module, f) {
            function g(i) {
        ...
        define("sdk.DOM", ["Assert", "createArrayFrom", "sdk.domReady", "UserAgent"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('Assert'),
                h = require('createArrayFrom'),
                i = require('sdk.domReady'),
                j = require('UserAgent'),
                k = {};
        ...
        define("sdk.Scribe", ["UrlMap", "QueryString"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('UrlMap'),
                h = require('QueryString');
        ...
        define("sdk.ErrorHandling", ["sdk.feature", "ManagedError", "sdk.Runtime", "sdk.Scribe", "UserAgent", "wrapFunction"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('sdk.feature'),
                h = require('ManagedError'),
                i = require('sdk.Runtime'),
                j = require('sdk.Scribe'),
                k = require('UserAgent'),
                l = require('wrapFunction'),
        ...
        define("sdk.Insights", ["sdk.Impressions"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('sdk.Impressions'),
                h = {
                    TYPE: {
                        NOTICE: 'notice',
                        WARNING: 'warn',
        ...
        define("FB", ["sdk.Auth", "copyProperties", "dotAccess", "sdk.domReady", "sdk.DOM", "sdk.ErrorHandling", "sdk.Content", "DOMWrapper", "GlobalCallback", "sdk.Insights", "Log", "sdk.Runtime", "sdk.Scribe", "CssConfig", "SDKConfig"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('sdk.Auth'),
                h = require('copyProperties'),
                i = requireDynamic('CssConfig'),
                j = require('dotAccess'),
        ...
        define("ArgumentError", ["ManagedError"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('ManagedError');
        ...
        define("CORSRequest", ["wrapFunction", "QueryString"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('wrapFunction'),
                h = require('QueryString');
        ...
        define("FlashRequest", ["DOMWrapper", "Flash", "GlobalCallback", "QueryString", "Queue"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('DOMWrapper'),
                h = require('Flash'),
                i = require('GlobalCallback'),
                j = require('QueryString'),
                k = require('Queue'),
                l, m = {}, n, o;
        ...
        define("flattenObject", [], function (a, require, requireDynamic, requireLazy, module, f) {
            function g(h) {
                var i = {};
                for (var j in h)
        ...
        define("JSONPRequest", ["DOMWrapper", "GlobalCallback", "QueryString"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('DOMWrapper'),
                h = require('GlobalCallback'),
                i = require('QueryString');
        ...
        define("ApiClient", ["ArgumentError", "Assert", "copyProperties", "CORSRequest", "FlashRequest", "flattenObject", "JSONPRequest", "Log", "ObservableMixin", "sprintf", "UrlMap", "URL", "ApiClientConfig"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('ArgumentError'),
                h = require('Assert'),
                i = require('copyProperties'),
                j = require('CORSRequest'),
                k = require('FlashRequest'),
                l = require('flattenObject'),
                m = require('JSONPRequest'),
                n = require('Log'),
                o = require('ObservableMixin'),
                p = require('sprintf'),
                q = require('UrlMap'),
                r = require('URL'),
                s = require('ApiClientConfig'),
                t, u, v, w = {
                    get: true,
                    post: true,
                    'delete': true,
        ...
        define("sdk.api", ["ApiClient", "sdk.Runtime"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('ApiClient'),
                h = require('sdk.Runtime'),
                i;
        ...
        define("legacy:fb.api", ["FB", "sdk.api"], function (a, b, requireDynamic, d) {
            var e = require('FB'),
                f = require('sdk.api');
            e.provide('', {
                api: f
        ...
        define("sdk.Canvas.Environment", ["sdk.RPC"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('sdk.RPC');
        ...
        define("sdk.Intl", ["Log"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('Log'),
                h = ('[' + '.!?' + '\u3002' + '\uFF01' + '\uFF1F' + '\u0964' + '\u2026' + '\u0EAF' + '\u1801' + '\u0E2F' + '\uFF0E' + ']');
        ...
        define("sdk.Dialog", ["sdk.Canvas.Environment", "sdk.Content", "sdk.DOM", "DOMEventListener", "sdk.Intl", "ObservableMixin", "sdk.Runtime", "Type", "UserAgent"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('sdk.Canvas.Environment'),
                h = require('sdk.Content'),
                i = require('sdk.DOM'),
                j = require('DOMEventListener'),
                k = require('sdk.Intl'),
                l = require('ObservableMixin'),
                m = require('sdk.Runtime'),
                n = require('Type'),
                o = require('UserAgent'),
                p = n.extend({
        ...
        define("sdk.Frictionless", ["sdk.Auth", "sdk.api", "sdk.Event", "sdk.Dialog"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('sdk.Auth'),
                h = require('sdk.api'),
                i = require('sdk.Event'),
                j = require('sdk.Dialog'),
                k = {
                    _allowedRecipients: {},
        ...
        define("insertIframe", ["guid", "GlobalCallback"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('guid'),
                h = require('GlobalCallback');
        ...
        define("sdk.Native", ["copyProperties", "Log", "UserAgent"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('copyProperties'),
                h = require('Log'),
                i = require('UserAgent'),
                j = 'fbNativeReady',
        ...
        define("sdk.UIServer", ["sdk.Auth", "sdk.Content", "copyProperties", "sdk.Dialog", "sdk.DOM", "sdk.Event", "flattenObject", "sdk.Frictionless", "sdk.getContextType", "guid", "insertIframe", "Log", "sdk.Native", "QueryString", "resolveURI", "sdk.RPC", "sdk.Runtime", "UrlMap", "UserAgent", "sdk.XD", "SDKConfig"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('sdk.Auth'),
                h = require('sdk.Content'),
                i = require('copyProperties'),
                j = require('sdk.Dialog'),
                k = require('sdk.DOM'),
                l = require('sdk.Event'),
                m = require('flattenObject'),
                n = require('sdk.Frictionless'),
                o = require('sdk.getContextType'),
                p = require('guid'),
                q = require('insertIframe'),
                r = require('Log'),
                s = require('sdk.Native'),
                t = require('QueryString'),
                u = require('resolveURI'),
                v = require('sdk.RPC'),
                w = require('sdk.Runtime'),
                x = requireDynamic('SDKConfig'),
                y = require('UrlMap'),
                z = require('UserAgent'),
                aa = require('sdk.XD'),
                ba = {
        ...
        define("sdk.ui", ["Assert", "copyProperties", "sdk.feature", "sdk.Impressions", "Log", "sdk.UIServer"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('Assert'),
                h = require('copyProperties'),
                i = require('sdk.feature'),
                j = require('sdk.Impressions'),
                k = require('Log'),
                l = require('sdk.UIServer');
        ...
        define("legacy:fb.auth", ["sdk.Auth", "sdk.Cookie", "copyProperties", "sdk.Event", "FB", "Log", "sdk.Runtime", "sdk.SignedRequest", "sdk.ui"], function (a, b, requireDynamic, d) {
        ...
        define("sdk.Canvas.Plugin", ["sdk.api", "sdk.RPC", "Log", "sdk.Runtime", "createArrayFrom"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('sdk.api'),
                h = require('sdk.RPC'),
                i = require('Log'),
                j = require('sdk.Runtime'),
                k = require('createArrayFrom'),
        ...
        define("sdk.Canvas.IframeHandling", ["DOMWrapper", "sdk.RPC"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('DOMWrapper'),
                h = require('sdk.RPC'),
                i = null,
                j;
        ...
        define("sdk.Canvas.Navigation", ["sdk.RPC"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('sdk.RPC');
        ...
        define("sdk.Canvas.Tti", ["sdk.RPC", "sdk.Runtime"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('sdk.RPC'),
                h = require('sdk.Runtime');
        ...
        define("legacy:fb.canvas", ["Assert", "sdk.Canvas.Environment", "sdk.Event", "FB", "sdk.Canvas.Plugin", "sdk.Canvas.IframeHandling", "Log", "sdk.Canvas.Navigation", "sdk.Runtime", "sdk.Canvas.Tti"], function (a, b, requireDynamic, d) {
            var e = require('Assert'),
                f = require('sdk.Canvas.Environment'),
                g = require('sdk.Event'),
                h = require('FB'),
                i = require('sdk.Canvas.Plugin'),
                j = require('sdk.Canvas.IframeHandling'),
                k = require('Log'),
                l = require('sdk.Canvas.Navigation'),
                m = require('sdk.Runtime'),
                n = require('sdk.Canvas.Tti');
            h.provide('Canvas', {
                setSize: function (o) {
        ...
        define("sdk.Canvas.Prefetcher", ["sdk.api", "createArrayFrom", "sdk.Runtime", "CanvasPrefetcherConfig"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('sdk.api'),
                h = require('createArrayFrom'),
                i = requireDynamic('CanvasPrefetcherConfig'),
                j = require('sdk.Runtime'),
                k = {
                    AUTOMATIC: 0,
                    MANUAL: 1
        ...
        define("legacy:fb.canvas.prefetcher", ["FB", "sdk.Canvas.Prefetcher", "sdk.Event", "sdk.Runtime"], function (a, b, requireDynamic, d) {
            var e = require('FB'),
                f = require('sdk.Canvas.Prefetcher'),
                g = require('sdk.Event'),
                h = require('sdk.Runtime');
        ...
        define("legacy:fb.compat.ui", ["copyProperties", "FB", "Log", "sdk.ui", "sdk.UIServer"], function (a, b, requireDynamic, d) {
            var e = require('copyProperties'),
                f = require('FB'),
                g = require('Log'),
                h = require('sdk.ui'),
                i = require('sdk.UIServer');
            f.provide('', {
                share: function (j) {
        ...
        define("mergeArrays", [], function (a, require, requireDynamic, requireLazy, module, f) {
            function g(h, i) {
        ...
        define("format", [], function (a, require, requireDynamic, requireLazy, module, f) {
            function g(h, i) {
        ...
        define("safeEval", [], function (a, require, requireDynamic, requireLazy, module, f) {
            function g(h, i) {
        ...
        define("sdk.Waitable", ["sdk.Model"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('sdk.Model'),
                h = g.extend({
        ...
        define("sdk.Query", ["format", "safeEval", "Type", "sdk.Waitable"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('format'),
                h = require('safeEval'),
                i = require('Type'),
                j = require('sdk.Waitable');
        ...
        define("sdk.Data", ["sdk.api", "sdk.ErrorHandling", "mergeArrays", "sdk.Query", "safeEval", "sdk.Waitable"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('sdk.api'),
                h = require('sdk.ErrorHandling'),
                i = require('mergeArrays'),
                j = require('sdk.Query'),
                k = require('safeEval'),
                l = require('sdk.Waitable'),
                m = {
                    query: function (n, o) {
        ...
        define("legacy:fb.data", ["FB", "sdk.Data"], function (a, b, requireDynamic, d) {
            var e = require('FB'),
                f = require('sdk.Data');
            e.provide('Data', f);
        }, 3);
        ...
        define("legacy:fb.event", ["FB", "sdk.Event"], function (a, b, requireDynamic, d) {
            var e = require('FB'),
                f = require('sdk.Event');
            e.provide('Event', f);
        ...
        define("legacy:fb.frictionless", ["FB", "sdk.Frictionless"], function (a, b, requireDynamic, d) {
            var e = require('FB'),
                f = require('sdk.Frictionless');
            e.provide('Frictionless', f);
        }, 3);


        define("sdk.init", ["sdk.Cookie", "copyProperties", "createArrayFrom", "sdk.ErrorHandling", "sdk.Event", "Log", "QueryString", "sdk.Runtime"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('sdk.Cookie'),
                h = require('copyProperties'),
        ...
        define("legacy:fb.init", ["FB", "sdk.init"], function (a, b, requireDynamic, d) {
            var e = require('FB'),
                f = require('sdk.init');
            e.provide('', {
                init: f
        ...
        define("legacy:fb.json", ["FB", "ManagedError"], function (a, b, requireDynamic, d) {
            var e = require('FB'),
                f = require('ManagedError');
            e.provide('JSON', {
        ...
        define("legacy:fb.pay", ["FB", "copyProperties", "sdk.Runtime", "sdk.UIServer", "sdk.XD"], function (a, b, requireDynamic, d) {
            require('FB');
            var e = require('copyProperties'),
                f = require('sdk.Runtime'),
                g = require('sdk.UIServer'),
                h = require('sdk.XD'),
                i = {
                    error_code: 1383001,
        ...
        define("legacy:fb.ua", ["FB", "UserAgent"], function (a, b, requireDynamic, d) {
            var e = require('FB'),
                f = require('UserAgent');
            e.provide('UA', {
        ...
        define("legacy:fb.ui", ["FB", "sdk.ui"], function (a, b, requireDynamic, d) {
            var e = require('FB'),
                f = require('sdk.ui');
            e.provide('', {
                ui: f
        ...
        define("Miny", [], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = 'Miny1',
                h = {
                    encode: [],
                    decode: {}
        ...
        define("runOnce", [], function (a, require, requireDynamic, requireLazy, module, f) {
            function g(h) {
                var i, j;
                return function () {
                    if (!i) {
        ...
        define("XFBML", ["Assert", "copyProperties", "createArrayFrom", "sdk.DOM", "sdk.feature", "sdk.Impressions", "Log", "ObservableMixin", "runOnce", "UserAgent"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('Assert'),
                h = require('copyProperties'),
                i = require('createArrayFrom'),
                j = require('sdk.DOM'),
                k = require('sdk.feature'),
                l = require('sdk.Impressions'),
                m = require('Log'),
        ...
        define("PluginPipe", ["sdk.Content", "copyProperties", "sdk.feature", "guid", "insertIframe", "Miny", "ObservableMixin", "sdk.Runtime", "UrlMap", "UserAgent", "XFBML", "PluginPipeConfig"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('sdk.Content'),
                h = require('copyProperties'),
                i = require('sdk.feature'),
                j = require('guid'),
                ...
                n = requireDynamic('PluginPipeConfig'),
        ...
        define("IframePlugin", ["sdk.Auth", "sdk.createIframe", "copyProperties", "sdk.DOM", "sdk.Event", "guid", "Log", "ObservableMixin", "PluginPipe", "QueryString", "resolveURI", "sdk.Runtime", "Type", "UrlMap", "UserAgent", "sdk.XD"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('sdk.Auth'),
                h = require('sdk.createIframe'),
                i = require('copyProperties'),
                j = require('sdk.DOM'),
        ...
        define("PluginTags", [], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = {
                activity: {
                    filter: 'string',
                    action: 'string',
        ...
        define("sdk.Arbiter", [], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = {
                BEHAVIOR_EVENT: 'e',
        ...
        define("sdk.XFBML.Element", ["sdk.DOM", "Type", "ObservableMixin"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('sdk.DOM'),
                h = require('Type'),
                i = require('ObservableMixin'),
                j = h.extend({
        ...
        define("sdk.XFBML.IframeWidget", ["sdk.Arbiter", "sdk.Auth", "sdk.Content", "copyProperties", "sdk.DOM", "sdk.Event", "sdk.XFBML.Element", "guid", "insertIframe", "QueryString", "sdk.Runtime", "sdk.ui", "UrlMap", "sdk.XD"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('sdk.Arbiter'),
                h = require('sdk.Auth'),
                i = require('sdk.Content'),
                j = require('copyProperties'),
                k = require('sdk.DOM'),
                l = require('sdk.Event'),
                m = require('sdk.XFBML.Element'),
                n = require('guid'),
                o = require('insertIframe'),
                p = require('QueryString'),
                q = require('sdk.Runtime'),
                r = require('sdk.ui'),
                s = require('UrlMap'),
        ...
        define("sdk.XFBML.Comments", ["sdk.Event", "sdk.XFBML.IframeWidget", "QueryString", "sdk.Runtime", "UrlMap", "UserAgent", "SDKConfig"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('sdk.Event'),
                h = require('sdk.XFBML.IframeWidget'),
                i = require('QueryString'),
                j = require('sdk.Runtime'),
                k = requireDynamic('SDKConfig'),
                l = require('UrlMap'),
                m = require('UserAgent'),
                n = h.extend({
        ...
        define("sdk.XFBML.CommentsCount", ["sdk.Data", "sdk.DOM", "sdk.XFBML.Element", "sprintf"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('sdk.Data'),
                h = require('sdk.DOM'),
                i = require('sdk.XFBML.Element'),
                j = require('sprintf'),
                k = i.extend({
                    process: function () {
        ...
        define("sdk.Anim", ["sdk.DOM"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('sdk.DOM'),
                h = {
        ...
        define("escapeHTML", [], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = /[&<>"'\/]/g,
                h = {
                    '&': '&amp; ',
                    '<': '&lt; ',
        ...
        define("sdk.Helper", ["sdk.ErrorHandling", "sdk.Event", "safeEval", "UrlMap"], function (a, require, requireDynamic, requireLazy, module, f) {
        ...
        define("sdk.XFBML.ConnectBar", ["sdk.Anim", "sdk.api", "sdk.Auth", "createArrayFrom", "sdk.Data", "sdk.DOM", "sdk.XFBML.Element", "escapeHTML", "sdk.Event", "format", "sdk.Helper", "sdk.Insights", "sdk.Intl", "sdk.Runtime", "UrlMap", "UserAgent", "ConnectBarConfig"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('sdk.Anim'),
                h = require('sdk.api'),
                i = require('sdk.Auth'),
                j = require('createArrayFrom'),
                k = requireDynamic('ConnectBarConfig'),
                l = require('sdk.Data'),
                m = require('sdk.DOM'),
                n = require('sdk.XFBML.Element'),
                o = require('escapeHTML'),
                p = require('sdk.Event'),
                q = require('format'),
                r = require('sdk.Helper'),
                s = require('sdk.Insights'),
                t = require('sdk.Intl'),
                u = require('sdk.Runtime'),
                v = require('UrlMap'),
                w = require('UserAgent'),
                x = n.extend({
                    _initialHeight: null,
        ...
        define("sdk.XFBML.EdgeCommentWidget", ["sdk.XFBML.IframeWidget", "sdk.DOM"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('sdk.XFBML.IframeWidget'),
                h = require('sdk.DOM'),
                i = 10000,
                j = g.extend({
                    constructor: function (k) {
        ...
        define("sdk.XFBML.EdgeWidget", ["sdk.Event", "sdk.XFBML.IframeWidget", "sdk.XFBML.EdgeCommentWidget", "sdk.DOM", "sdk.Helper", "sdk.Runtime"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('sdk.Event'),
                h = require('sdk.XFBML.IframeWidget'),
                i = require('sdk.XFBML.EdgeCommentWidget'),
                j = require('sdk.DOM'),
                k = require('sdk.Helper'),
                l = require('sdk.Runtime'),
                m = h.extend({
                    _visibleAfter: 'immediate',
                    _showLoader: false,
                    _rootPadding: null,
        ...
        define("sdk.XFBML.SendButtonFormWidget", ["sdk.XFBML.EdgeCommentWidget", "sdk.DOM", "sdk.Event"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('sdk.XFBML.EdgeCommentWidget'),
                h = require('sdk.DOM'),
                i = require('sdk.Event'),
                j = g.extend({
                    constructor: function (k) {
        ...
        define("sdk.XFBML.Like", ["sdk.XFBML.EdgeWidget", "sdk.XFBML.SendButtonFormWidget"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('sdk.XFBML.EdgeWidget'),
                h = require('sdk.XFBML.SendButtonFormWidget'),
                i = g.extend({
                    getUrlBits: function () {
                        return {
                            name: 'like',
        ...
        define("sdk.XFBML.LiveStream", ["sdk.XFBML.IframeWidget"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('sdk.XFBML.IframeWidget'),
                h = g.extend({
                    _visibleAfter: 'load',
                    setupAndValidate: function () {
        ...
        define("sdk.XFBML.LoginButton", ["sdk.Helper", "IframePlugin"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('sdk.Helper'),
                h = require('IframePlugin'),
                i = h.extend({
        ...
        define("sdk.XFBML.Name", ["copyProperties", "sdk.Data", "escapeHTML", "sdk.Event", "sdk.XFBML.Element", "sdk.Helper", "Log", "sdk.Runtime"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('copyProperties'),
                h = require('sdk.Data'),
                i = require('escapeHTML'),
                j = require('sdk.Event'),
                k = require('sdk.XFBML.Element'),
                l = require('sdk.Helper'),
                m = require('Log'),
                n = require('sdk.Runtime'),
                o = k.extend({
                    process: function () {
        ...
        define("sdk.XFBML.RecommendationsBar", ["sdk.Arbiter", "DOMEventListener", "sdk.Event", "sdk.XFBML.IframeWidget", "resolveURI", "sdk.Runtime"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('sdk.Arbiter'),
                h = require('DOMEventListener'),
                i = require('sdk.Event'),
                j = require('sdk.XFBML.IframeWidget'),
                k = require('resolveURI'),
                l = require('sdk.Runtime'),
                m = j.extend({
                    getUrlBits: function () {
                        return {
        ...
        define("sdk.XFBML.Registration", ["sdk.Auth", "sdk.Helper", "sdk.XFBML.IframeWidget", "sdk.Runtime", "UrlMap"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('sdk.Auth'),
                h = require('sdk.Helper'),
                i = require('sdk.XFBML.IframeWidget'),
                j = require('sdk.Runtime'),
                k = require('UrlMap'),
                l = i.extend({
                    _visibleAfter: 'immediate',
        ...
        define("sdk.XFBML.SocialContext", ["sdk.Event", "sdk.XFBML.IframeWidget"], function (a, require, requireDynamic, requireLazy, module, f) {
            var g = require('sdk.Event'),
                h = require('sdk.XFBML.IframeWidget'),
                i = h.extend({
                    setupAndValidate: function () {
        ...
        define("legacy:fb.xfbml", ["Assert", "sdk.domReady", "sdk.Event", "FB", "IframePlugin", "PluginTags", "wrapFunction", "XFBML", "sdk.XFBML.Comments", "sdk.XFBML.CommentsCount", "sdk.XFBML.ConnectBar", "sdk.XFBML.Like", "sdk.XFBML.LiveStream", "sdk.XFBML.LoginButton", "sdk.XFBML.Name", "sdk.XFBML.RecommendationsBar", "sdk.XFBML.Registration", "sdk.XFBML.SocialContext"], function (a, b, requireDynamic, d) {
            var e = require('Assert'),
                f = require('sdk.domReady'),
                g = require('sdk.Event'),
                h = require('FB'),
                i = require('IframePlugin'),
                j = require('PluginTags'),
                k = require('wrapFunction'),
                l = require('XFBML'),
                m = {
